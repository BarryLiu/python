...
for i in range(1,100):
	logger5.debug('logger5 debug message%d'%i)
	logger5.info('logger5 info message%d'%i)
	logger5.warning('logger5 warning message%d'%i)
	logger5.error('logger5 error message%d'%i)
	logger5.critical('logger5 critical message%d'%i)
	time.sleep(1)
	pass